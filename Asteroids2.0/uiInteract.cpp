...
Point Interface::getTopLeft()
{
	int viewport_width = glutGet(GLUT_SCREEN_WIDTH);
	int viewport_height = glutGet(GLUT_SCREEN_HEIGHT);
	Point screenTopLeft(-(viewport_width / 2), viewport_height / 2);
	Point screenBottomRight(viewport_width / 2, -(viewport_height / 2));
	return screenTopLeft;
}

Point Interface::getBottomRight()
{
	int viewport_width = glutGet(GLUT_SCREEN_WIDTH);
	int viewport_height = glutGet(GLUT_SCREEN_HEIGHT);
	Point screenTopLeft(-(viewport_width / 2), viewport_height / 2);
