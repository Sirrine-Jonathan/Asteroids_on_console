 ...
 * Draw a blue hexagon from a given location (center) of a given size (radius).
 *************************************************************************/	
void drawShield(const Point & center, int radius, int rotation, int points = 6, float red = 0.0, float green = 0.0, float blue = 1.0);
